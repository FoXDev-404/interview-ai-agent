  ...
  return (
    <form onSubmit={handleSubmit} className="saas-form">
      ...
      <motion.div
        ...
        animate="visible"
        custom={0}
        className="saas-field-group"
      >
        <label htmlFor="role" className="saas-label">
          Job Role
          <span className="saas-label-hint">
            Title you are preparing to interview for
          </span>
        </label>
        <div className="saas-input-wrap" ref={roleMenuRef}>
          <svg
            className="saas-input-icon"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={1.5}
          ...
          >
            <span
              className={`saas-role-trigger-text ${formData.role ? "saas-role-trigger-text-filled" : ""}`}
            >
              {formData.role || "Select your target role"}
            </span>
          </button>
          <svg
            className="saas-select-arrow"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
      ...
      >
        <label className="saas-label">
          Experience Level
          <span className="saas-label-hint">
            Difficulty and expectations align to this level
          </span>
        </label>
      ...
      >
        <label className="saas-label">
          Interview Mode
          <span className="saas-label-hint">
            Pick the focus area for this run
          </span>
        </label>
      ...
      {formData.type === "Coding" && (
        ...
        >
          <label htmlFor="codingLanguage" className="saas-label">
            ...
            <span className="saas-label-hint">
              Problems and test cases will use this language
            </span>
          </label>
          <div className="saas-input-wrap">
            <select
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  codingLanguage: e.target.value as CodingLanguage,
                }))
              }
            >
      ...
      {formData.type !== "Coding" && (
        ...
        >
          <label className="saas-label">
            Technologies & Skills
            <span className="saas-label-hint">
              Select the stack you want interviewers to probe
            </span>
          </label>
            ...
            {formData.techstack.length > 0 && (
              ...
              >
                <div className="saas-selected-header">
                  <span className="saas-selected-count">
                  ...
                  {formData.techstack.map((t) => (
                    <span key={t} className="saas-tag">
                      ...
                      <button
                        ...
                        className="saas-tag-remove"
                        aria-label={`Remove ${t} from selected technologies`}
                        title={`Remove ${t}`}
                      >
                        ×
                      </button>
        ...
        <div className="saas-live-summary-grid">
          <div className="saas-live-summary-item">
            ...
            <p className="saas-summary-value">
              {formData.role.trim() || "Not set yet"}
            </p>
          </div>
          <div className="saas-live-summary-item">
            ...
            <p className="saas-summary-value">
              {formData.type === "Coding"
                ? CODING_LANGUAGES.find(
                    (lang) => lang.value === formData.codingLanguage,
                  )?.label
                : `${formData.techstack.length} selected`}
            </p>
          </div>
